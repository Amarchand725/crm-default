                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check($menu->menu.'-list')): ?>
                        <div data-kt-menu-trigger="click"  class="menu-item menu-accordion" >
                            ...
                            <div  class="menu-sub menu-sub-accordion menu-active-bg <?php echo e(request()->is('"'.$menu->url.'"') ||
                                ...
                                <div  class="menu-item" >
                                    <!--begin:Menu link-->
                                    <a class="menu-link <?php echo e(request()->is("'".$menu->url."'") ? 'active' : ''); ?>" href="<?php echo e(route($menu->menu.'.index')); ?>" title="<?php echo e($menu->lablel); ?>" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right" >
                                ...
                                <div  class="menu-item" >
                                    <!--begin:Menu link-->
                                    <a class="menu-link <?php echo e(request()->is("'".$menu->url."/create'") ? 'active' : ''); ?>" href="<?php echo e(route($menu->menu.'.create')); ?>" title="<?php echo e($menu->lablel); ?>" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right" >
                                        <span  class="menu-bullet" ><?php echo $menu->icon; ?></span>
...
<?php /**PATH C:\wamp\www\crm-default\resources\views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>