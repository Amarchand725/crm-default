                    ...
                    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                        ...
                        <div class="d-flex align-items-center gap-2 gap-lg-3">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission-create')): ?>
                                <a href="<?php echo e(route('permission.create')); ?>" class="btn btn-sm fw-bold btn-primary">Add New Permission</a>
                            <?php endif; ?>
                            <a href="<?php echo e(route('admin.permission.trash.records')); ?>" title="Permission All Trash Records" class="btn btn-sm fw-bold btn-primary">Restore</a>
                                    ...
                                    <tbody id="body">
                                        <?php $__currentLoopData = $models; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr id="id-<?php echo e($model->id); ?>">
                                                ...
                                                <?php $per = explode('-', $model->name) ?>
                                                <td><?php echo e($per[0]); ?></td>
                                                <td><?php echo e($per[1]); ?></td>
                                                ...
                                                <td>
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission-edit')): ?>
                                                        <a href="<?php echo e(route('permission.edit', $model->id)); ?>" data-toggle="tooltip" data-placement="top" title="Edit permission" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Edit</a>
                                                    <?php endif; ?>
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('permission-delete')): ?>
                                                        <button class="btn btn-danger btn-sm delete" data-slug="<?php echo e($model->id); ?>" data-del-url="<?php echo e(route('permission.destroy', $model->id)); ?>"><i class="fa fa-trash"></i> Delete</button>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\crm-default\resources\views/admin/permission/index.blade.php ENDPATH**/ ?>