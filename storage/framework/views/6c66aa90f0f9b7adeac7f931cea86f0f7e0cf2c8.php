            ...
            <div  data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"  class="menu-item menu-lg-down-accordion me-lg-1" >
                ...
                <div  class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px" >
                    ...
                    <div  class="menu-item" >
                        ...
                        <a class="menu-link py-3"  href="<?php echo e(route('role.index')); ?>" title="All Roles" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right" >
                    ...
                    <div  class="menu-item" >
                        ...
                        <a class="menu-link py-3"  href="<?php echo e(route('permission.index')); ?>" title="All Permissions" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right" >
                            <span  class="menu-bullet" >
                                <span class="bullet bullet-dot"></span>
                            </span>
                    ...
                    <div  class="menu-item" >
                        ...
                        <a class="menu-link py-3"  href="<?php echo e(route('admin.system.company.profile')); ?>" title="Company Profile" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right" >
                            <span  class="menu-bullet" >
                                <span class="bullet bullet-dot"></span>
                            </span>
                    ...
                    <div  class="menu-item" >
                        ...
                        <a class="menu-link py-3"  href="<?php echo e(route('admin.email-config')); ?>" title="Email Configuration" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                            <span  class="menu-bullet" >
                                <span class="bullet bullet-dot"></span>
                            </span>
                    ...
                    <div  class="menu-item" >
                        ...
                        <a class="menu-link py-3"  href="<?php echo e(route('admin.logActivity')); ?>" title="System Log Activity" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                            <span  class="menu-bullet" >
                                <span class="bullet bullet-dot"></span>
                            </span>
    ...
    <div class="app-navbar flex-shrink-0">
        ...
        <div class="app-navbar-item ms-1 ms-lg-3">
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                <!--begin::Heading-->
                <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('<?php echo e(asset('public/admin')); ?>/media/misc/pattern-1.jpg')">
                    <!--begin::Title-->
                    ...
                    <div class="tab-pane fade show active" id="kt_topbar_notifications_1" role="tabpanel">
                            ...
                            <?php $__currentLoopData = auth()->user()->unreadnotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="d-flex flex-stack py-4">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Title-->
                                        <div class="mb-0 me-2">
                                            <a href="<?php echo e(route('admin.markasread', $notification->id)); ?>" class="fs-6 text-gray-800 text-hover-primary fw-bold"><?php echo e($notification->data['name']); ?></a>
                                            <div class="text-gray-400 fs-7"><?php echo e($notification->data['email']); ?></div>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Section-->
                                    <!--begin::Label-->
                                    <span class="badge badge-light fs-8"><?php echo e($notification->updated_at->diffForHumans()); ?></span>
                                    <!--end::Label-->
                                </div>
                        ...
                        <?php if(count(auth()->user()->unreadnotifications)): ?>
                            <div class="py-3 text-center border-top">
                                <a href="<?php echo e(route('admin.view.all.notifications')); ?>" class="btn btn-color-gray-600 btn-active-color-primary">View All
        ...
        <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
            ...
            <?php if(!empty(Auth::user()->hasProfile->avatar)): ?>
                <?php
                    $avatar = asset('public/avatar').'/'.Auth::user()->hasProfile->avatar;
                ?>
            <?php endif; ?>
            <div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                <img src="<?php echo e($avatar); ?>" alt="user" />
            </div>
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                ...
                <div class="menu-item px-3">
                    <div class="menu-content d-flex align-items-center px-3">
                        ...
                        <div class="symbol symbol-50px me-5">
                            <img alt="Logo" src="<?php echo e($avatar); ?>" />
                        </div>
                        <!--end::Avatar-->
                        <!--begin::Username-->
                ...
                <div class="menu-item px-5">
                    <a href="<?php echo e(route('admin.profile')); ?>" class="menu-link px-5">My Profile</a>
                </div>
                <!--end::Menu item-->
                <!--begin::Menu separator-->
                <div class="separator my-2"></div>
                ...
                <!--begin::Menu item-->
                <div class="menu-item px-5">
                    <a class="button-ajax menu-link px-5" title="Logout" href="<?php echo e(route('admin.logout')); ?>"
...
<?php /**PATH C:\wamp\www\crm-default\resources\views/admin/layouts/header.blade.php ENDPATH**/ ?>